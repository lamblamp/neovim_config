...
highlight clear CoursorLine
highlight CoursorLine gui=underline
highlight CoursorLine ctermbg=black guibg=black
...
let g:win_ime_con_mode=0     " plugin#win-ime-con.nvim インサートモードになるときは常にIMEがOFFとなる
...
" Python
" -----------------------------------------------------------------------------
let g:python3_host_prog = 'C:\Users\Cozynet-140\AppData\Local\Programs\Python\Python39\python.exe'
